...
b=th("//web.archive.org/web/20211103085541/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Gf&&b.abort();
return Df(c)})}
...
function Cn(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=ab(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20211103085541/https://fonts.gstatic.com/s/")});
...
try{Pn("//web.archive.org/web/20211103085541/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Wn.push(Rg.L(function(){if(!(Xn||"google_ad_status"in window)){try{Vn("//web.archive.org/web/20211103085541/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Xn=!0;L("DCLKSTAT",3)}},5E3))}}
...
G("PL_ATT")&&eo.dispose();for(var a=0,b=Wn.length;a<b;a++)Rg.aa(Wn[a]);Wn.length=0;Un("//web.archive.org/web/20211103085541/https://static.doubleclick.net/instream/ad_status.js");Xn=!1;L("DCLKSTAT",0);(0,Vd)(ip,hp);gp&&(gp.removeEventListener("onVideoDataChange",jp),gp.destroy())});
...
/*
     FILE ARCHIVED ON 08:55:41 Nov 03, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:17:31 Jun 29, 2026.
...
playback timings (ms):
  ...
  load_resource: 135.832 (2)
  PetaboxLoader3.resolve: 109.503 (2)
  PetaboxLoader3.datanode: 17.477 (2)
*/