...
b=Ah("//web.archive.org/web/20211112183131/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Kf&&b.abort();
return Gf(c)})}
...
function Ln(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=bb(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20211112183131/https://fonts.gstatic.com/s/")});
...
try{Yn("//web.archive.org/web/20211112183131/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}fo.push(Yg.L(function(){if(!(go||"google_ad_status"in window)){try{eo("//web.archive.org/web/20211112183131/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}go=!0;L("DCLKSTAT",3)}},5E3))}}
...
F("PL_ATT")&&no.dispose();for(var a=0,b=fo.length;a<b;a++)Yg.aa(fo[a]);fo.length=0;co("//web.archive.org/web/20211112183131/https://static.doubleclick.net/instream/ad_status.js");go=!1;L("DCLKSTAT",0);(0,Wd)(rp,qp);pp&&(pp.removeEventListener("onVideoDataChange",sp),pp.destroy())});
...
/*
     FILE ARCHIVED ON 18:31:31 Nov 12, 2021 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  load_resource: 550.002
  PetaboxLoader3.resolve: 464.921
  PetaboxLoader3.datanode: 75.999
*/