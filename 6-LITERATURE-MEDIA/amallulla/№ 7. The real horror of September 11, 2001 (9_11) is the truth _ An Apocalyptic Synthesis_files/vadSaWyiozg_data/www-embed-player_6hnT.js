...
b=Wh("//web.archive.org/web/20211130145641/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Lf&&b.abort();
return If(c)})}
...
function Ao(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=cb(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20211130145641/https://fonts.gstatic.com/s/")});
...
try{No("//web.archive.org/web/20211130145641/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Uo.push(th.L(function(){if(!(Vo||"google_ad_status"in window)){try{To("//web.archive.org/web/20211130145641/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Vo=!0;M("DCLKSTAT",3)}},5E3))}}
...
F("PL_ATT")&&bp.dispose();for(var a=0,b=Uo.length;a<b;a++)th.aa(Uo[a]);Uo.length=0;So("//web.archive.org/web/20211130145641/https://static.doubleclick.net/instream/ad_status.js");Vo=!1;M("DCLKSTAT",0);(0,Ud)(iq,hq);gq&&(gq.removeEventListener("onVideoDataChange",jq),gq.destroy())});
...
/*
     FILE ARCHIVED ON 14:56:41 Nov 30, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:17:23 Jun 29, 2026.
...
playback timings (ms):
  ...
  load_resource: 1394.639 (2)
  PetaboxLoader3.resolve: 1312.284 (2)
  PetaboxLoader3.datanode: 64.644 (2)
*/