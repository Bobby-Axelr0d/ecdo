...
b=Ch("//web.archive.org/web/20211105143455/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Nf&&b.abort();
return Kf(c)})}
...
function Jn(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=ab(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20211105143455/https://fonts.gstatic.com/s/")});
...
try{Wn("//web.archive.org/web/20211105143455/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}co.push($g.L(function(){if(!(eo||"google_ad_status"in window)){try{bo("//web.archive.org/web/20211105143455/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}eo=!0;L("DCLKSTAT",3)}},5E3))}}
...
F("PL_ATT")&&lo.dispose();for(var a=0,b=co.length;a<b;a++)$g.aa(co[a]);co.length=0;ao("//web.archive.org/web/20211105143455/https://static.doubleclick.net/instream/ad_status.js");eo=!1;L("DCLKSTAT",0);(0,Zd)(pp,op);np&&(np.removeEventListener("onVideoDataChange",qp),np.destroy())});
...
/*
     FILE ARCHIVED ON 14:34:55 Nov 05, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:17:29 Jun 29, 2026.
...
playback timings (ms):
  ...
  load_resource: 298.616
  PetaboxLoader3.resolve: 282.068
  PetaboxLoader3.datanode: 3.332
*/