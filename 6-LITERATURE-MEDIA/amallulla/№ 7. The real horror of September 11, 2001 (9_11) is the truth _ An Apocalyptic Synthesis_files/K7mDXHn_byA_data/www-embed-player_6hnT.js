...
b=xh("//web.archive.org/web/20211103105332/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Jf&&b.abort();
return Gf(c)})}
...
function En(){var a=window.location.protocol,b=W.getEntriesByType("resource");b=ab(b,function(c){return 0===c.name.indexOf(a+"//web.archive.org/web/20211103105332/https://fonts.gstatic.com/s/")});
...
try{Rn("//web.archive.org/web/20211103105332/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Yn.push(Vg.L(function(){if(!(Zn||"google_ad_status"in window)){try{Xn("//web.archive.org/web/20211103105332/https://static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Zn=!0;L("DCLKSTAT",3)}},5E3))}}
...
F("PL_ATT")&&go.dispose();for(var a=0,b=Yn.length;a<b;a++)Vg.aa(Yn[a]);Yn.length=0;Wn("//web.archive.org/web/20211103105332/https://static.doubleclick.net/instream/ad_status.js");Zn=!1;L("DCLKSTAT",0);(0,Vd)(kp,jp);ip&&(ip.removeEventListener("onVideoDataChange",lp),ip.destroy())});
...
/*
     FILE ARCHIVED ON 10:53:32 Nov 03, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:17:16 Jun 29, 2026.
...
playback timings (ms):
  ...
  load_resource: 306.607 (2)
  PetaboxLoader3.resolve: 121.385 (2)
  PetaboxLoader3.datanode: 140.217 (3)
  loaddict: 47.354
*/